...
--> statement-breakpoint
ALTER TABLE "analytic_events" ADD CONSTRAINT "analytic_events_brand_id_brands_id_fk" FOREIGN KEY ("brand_id") REFERENCES "public"."brands"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "analytic_events" ADD CONSTRAINT "analytic_events_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "brands_user_id_idx" ON "brands" USING btree ("user_id");--> statement-breakpoint
