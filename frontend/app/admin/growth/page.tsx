  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-surface border border-border rounded-2xl p-12 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-xl font-bold text-foreground mb-2">Detailed Analytics Coming Soon</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 opacity-50">
        <div className="bg-surface border border-border rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-bold text-foreground">Retention Rate</h3>
          </div>
        ...
        <div className="bg-surface border border-border rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-bold text-foreground">Churn Analysis</h3>
          </div>
          <p className="text-sm text-muted">Awaiting more historical data...</p>
        </div>
      </div>
